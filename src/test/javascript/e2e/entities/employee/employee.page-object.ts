...
export class EmployeeUpdatePage {
    ...
    employeeHasAddressSelect = element(by.id('field_employeeHasAddress'));
    ...
    async employeeHasAddressSelectLastOption() {
        await this.employeeHasAddressSelect
            .all(by.tagName('option'))
            .last()
            .click();
    }

    async employeeHasAddressSelectOption(option) {
        await this.employeeHasAddressSelect.sendKeys(option);
    }

    getEmployeeHasAddressSelect(): ElementFinder {
        return this.employeeHasAddressSelect;
    }

    async getEmployeeHasAddressSelectedOption() {
        return this.employeeHasAddressSelect.element(by.css('option:checked')).getText();
    }
