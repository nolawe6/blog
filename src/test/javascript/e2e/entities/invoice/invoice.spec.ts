...
describe('Invoice e2e test', () => {
    ...
    it('should load Invoices', async () => {
        ...
        expect(await invoiceComponentsPage.getTitle()).to.eq('blogApp.invoice.home.title');
    });
    ...
    it('should load create Invoice page', async () => {
        ...
        expect(await invoiceUpdatePage.getPageTitle()).to.eq('blogApp.invoice.home.createOrEditLabel');
    ...
    it('should delete last Invoice', async () => {
        ...
        expect(await invoiceDeleteDialog.getDialogTitle()).to.eq('blogApp.invoice.delete.question');
