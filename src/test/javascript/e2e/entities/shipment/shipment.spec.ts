...
describe('Shipment e2e test', () => {
    ...
    it('should load Shipments', async () => {
        ...
        expect(await shipmentComponentsPage.getTitle()).to.eq('blogApp.shipment.home.title');
    });
    ...
    it('should load create Shipment page', async () => {
        ...
        expect(await shipmentUpdatePage.getPageTitle()).to.eq('blogApp.shipment.home.createOrEditLabel');
    ...
    it('should delete last Shipment', async () => {
        ...
        expect(await shipmentDeleteDialog.getDialogTitle()).to.eq('blogApp.shipment.delete.question');
