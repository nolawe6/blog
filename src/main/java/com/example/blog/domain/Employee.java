...
public class Employee implements Serializable {
    ...
    @JsonIgnoreProperties("employees")
    private Address employeeHasAddress;
    ...
    public Address getEmployeeHasAddress() {
        return employeeHasAddress;
    }

    public Employee employeeHasAddress(Address address) {
        this.employeeHasAddress = address;
        return this;
    }

    public void setEmployeeHasAddress(Address address) {
        this.employeeHasAddress = address;
    }
